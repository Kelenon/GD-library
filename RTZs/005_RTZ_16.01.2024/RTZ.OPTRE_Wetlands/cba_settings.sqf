...
AH_Hitsound_type = ["AH_hit1","AH_hit2"];
AH_Hitsound_volume = 1;
AH_Killmarker = true;
AH_Killmarker_head = true;
AH_Killsound_headshot_type = "AH_head2";
AH_Killsound_headshot_volume = 1;
AH_Killsound_type = "AH_kill1";
AH_Killsound_volume = 1;
AH_PlayerDeathSound_type = "AH_PD_wasted";
AH_PlayerDeathSound_volume = 1;
...
OPTRE_HELMET_HUD_SANGHEILI = "OPTRE_FC_Elite_Helmet_FieldMarshal,OPTRE_FC_Elite_Helmet_HonorGuard_Ultra,OPTRE_FC_Elite_Helmet_HonorGuard,OPTRE_FC_Elite_Helmet_Major,OPTRE_FC_Elite_Helmet_Officer,OPTRE_FC_Elite_Helmet_Minor,OPTRE_FC_Elite_Helmet_SpecOps,OPTRE_FC_Elite_Helmet_Ultra,OPTRE_FC_Elite_Helmet_Zealot";
...
// Sci-fi Support PLUS
force ScifiSupportPlus_Archer = false;
force ScifiSupportPlus_ArcherBarrage = false;
force ScifiSupportPlus_Cov_ConstructionPod = false;
force ScifiSupportPlus_COV_GlassingStrike = false;
force ScifiSupportPlus_cov_sup_pod = false;
...
force ScifiSupportPlus_FloodDropPod = false;
force ScifiSupportPlus_HeavyInsertionPod = false;
force ScifiSupportPlus_HunterInsertionPod = false;
force ScifiSupportPlus_InsertionPod = false;
force ScifiSupportPlus_JumpShipIn = false;
force ScifiSupportPlus_JumpShipOut = false;
force ScifiSupportPlus_MACStrike = false;
force ScifiSupportPlus_MoveShip = false;
force ScifiSupportPlus_NeedleStorm = false;
force ScifiSupportPlus_OrbitalAutocannon = false;
force ScifiSupportPlus_Pelicanvehicledrop = false;
force ScifiSupportPlus_PlasmaBomb = false;
force ScifiSupportPlus_PlasmaLanceStrike = false;
force ScifiSupportPlus_PlasmaMortar = false;
force ScifiSupportPlus_PlasmaStorm = false;
force ScifiSupportPlus_PlasmaTorpedo = false;
force ScifiSupportPlus_PlasmaTorpedoStrike = false;
force ScifiSupportPlus_SelectShip = false;
force ScifiSupportPlus_ShredderCannon = false;
force ScifiSupportPlus_Spiritvehicledrop = false;
force ScifiSupportPlus_UNSC_ConstructionPod = false;
force ScifiSupportPlus_UNSC_OrbitalVehicleDeployment = false;
force ScifiSupportPlus_UNSC_sup_pod = false;
force ScifiSupportPlus_UNSCHeavyInsertionPod = false;
...
WBK_HA_EltHlth = "300";
WBK_HA_EnableHunterRageHpBon = true;
WBK_HA_EnableIndepAi = true;
WBK_HA_GrntHlth = "50";
WBK_HA_HntrHlth = "1000";
...
zen_faction_filter_1_985_Icarus = true;
...
zen_faction_filter_1_GD_Faction_Clones = true;
