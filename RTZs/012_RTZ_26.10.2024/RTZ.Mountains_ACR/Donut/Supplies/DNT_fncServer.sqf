DNT_initSuppliesServer = {
	...
	call DNT_readParamsFromDb;
	
	["all"] call DNT_readFromDbPublic;

};

/* DNT_readParamsFromDb
* Read params stored in DB and declares them as public variables
*/

DNT_readParamsFromDb = {

	private _inidbi = ["new","DNT_params"] call OO_INIDBI;

	DNT_tinyCargoSize = ["read", ["Vehicle cargo size categories", "tinyCargoSize"]] call _inidbi; 
	publicVariable "DNT_tinyCargoSize";
	DNT_smallCargoSize = ["read", ["Vehicle cargo size categories", "smallCargoSize"]] call _inidbi; 
	publicVariable "DNT_smallCargoSize";
	DNT_mediumCargoSize = ["read", ["Vehicle cargo size categories", "mediumCargoSize"]] call _inidbi; 
	publicVariable "DNT_mediumCargoSize";
	DNT_largeCargoSize = ["read", ["Vehicle cargo size categories", "largeCargoSize"]] call _inidbi; 
	publicVariable "DNT_largeCargoSize";
	DNT_gargantuanCargoSize = ["read", ["Vehicle cargo size categories", "gargantuanCargoSize"]] call _inidbi; 
	publicVariable "DNT_gargantuanCargoSize";

	DNT_sizeXS = ["read", ["Params cargo size", "sizeXS",2]] call _inidbi; 
	publicVariable "DNT_sizeXS";
	DNT_sizeS = ["read", ["Params cargo size", "sizeS",10]] call _inidbi; 
	publicVariable "DNT_sizeS";
	DNT_sizeM = ["read", ["Params cargo size", "sizeM",25]] call _inidbi; 
	publicVariable "DNT_sizeM";
	DNT_sizeL = ["read", ["Params cargo size", "sizeL",50]] call _inidbi; 
	publicVariable "DNT_sizeL";
	DNT_sizeXL = ["read", ["Params cargo size", "sizeXL",500]] call _inidbi; 
	publicVariable "DNT_sizeXL";

	DNT_timeXS = ["read", ["Params salvage time", "timeXS",10]] call _inidbi; 
	publicVariable "DNT_timeXS";
	DNT_timeS = ["read", ["Params salvage time", "timeS",15]] call _inidbi; 
	publicVariable "DNT_timeS";
	DNT_timeM = ["read", ["Params salvage time", "timeM",20]] call _inidbi; 
	publicVariable "DNT_timeM";
	DNT_timeL = ["read", ["Params salvage time", "timeL",30]] call _inidbi; 
	publicVariable "DNT_timeL";
	DNT_timeXL = ["read", ["Params salvage time", "timeXL",60]] call _inidbi; 
	publicVariable "DNT_timeXL";

	DNT_scrapToAmmo = ["read", ["Fabricator exchange rates", "scrapToAmmo",100]] call _inidbi; 
	publicVariable "DNT_scrapToAmmo";
	DNT_ammoForScrap = ["read", ["Fabricator exchange rates", "ammoForScrap",100]] call _inidbi; 
	publicVariable "DNT_ammoForScrap";

	DNT_scrapToMeds = ["read", ["Fabricator exchange rates", "scrapToMeds",100]] call _inidbi; 
	publicVariable "DNT_scrapToMeds";
	DNT_medsForScrap = ["read", ["Fabricator exchange rates", "medsForScrap",50]] call _inidbi; 
	publicVariable "DNT_medsForScrap";

	private _inidbi = ["new","DNT_vehiclePrices"] call OO_INIDBI;

	DNT_vehiclePriceList = ["read", ["Vehicle price list", "vehiclePriceList"]] call _inidbi; 
	publicVariable "DNT_vehiclePriceList";	
