			...
			_target addAction [_actionText,{
				...
				
				{
					...
					_target addAction [_actionText, {
						...
						if(_vicType in ["Transport ship", "Juggernaut", "GAR AV-7 Artillery", "AT-AT", "Rho A-Class Shuttle", "Rho Crate"]) then {
...
DNT_phantomSpawnActions = {
	...
	switch (true) do {
		...
		case (_vicType == "AT-RT"): {_subTypesClasses = [["AT-RT", "3AS_ATRT"]]};
		case (_vicType == "PX-10"): {_subTypesClasses = [["GD PX-10","GD_PX10"], ["Standard PX-10","3AS_PX10_REP_F"], ["Minesweeper PX-10","3AS_PX10_REP_R3"], ["Up-armor variant PX-10","3AS_PX10_REP_UP"]]};
		...
		case (_vicType == "RX200"): {_subTypesClasses = [["RX-200", "3AS_RX200_Base"]]};
		...
		//Heavy aerial vehicles
		case (_vicType == "Rho A-Class Shuttle"): {_subTypesClasses = [["Rho A-Class Shuttle Standard","3AS_Rho_REP_F"], ["Rho A-Class Shuttle Medical","3AS_Rho_REP_Medical"]]};
		case (_vicType == "Rho Crate"): {_subTypesClasses = [["Rho Crate - Barracks","3AS_Rho_Crate_REP_Barracks"], ["Rho Crate - Medical","3AS_Rho_Crate_REP_Medical"], ["Rho Crate - Transport","3AS_Rho_Crate_REP_Transport"]]};
