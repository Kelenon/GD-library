...
DNT_scrapFabricator = {
	...
	_terminal addAction ["Login to scrap fabricator...",{
		...
		if(([_caller, 1] call ace_repair_fnc_isEngineer) == true) then {
			...
			private _scrapToAmmo = 20;
			private _scrapToMeds = 10;
