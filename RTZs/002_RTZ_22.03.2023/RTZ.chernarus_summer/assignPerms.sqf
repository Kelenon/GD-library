if (!isNil "_this") then {
	...
	_assign addAction ["Assign Medic Perms", {if(typeOf unitBackpack player regexMatch ".*GD_Med.*") 
	...
	_assign addAction ["Assign Engineer Perms", {if(typeOf unitBackpack player regexMatch ".*eod.*") 
