diag_log "initPlayerLocal.sqf starts";
...
diag_log "initPlayerLocal.sqf before waitUntil";

//Supplies

waitUntil{!isNil "DNT_initSupplies"};

call DNT_initSupplies;

diag_log "initPlayerLocal.sqf executed DNT_initSupplies on client";

if(isNull getAssignedCuratorLogic _playerUnit) then {

	_playerUnit call DNT_onReloadEH;
	call DNT_onTreatmentEH;
