//If you want to turn off supply system set this value to 0
dnt_supplySystemON = 1; 
publicVariable "dnt_supplySystemON";
...
if(dnt_supplySystemON ==1) then {
	...
	//Initialize inidb read/write script
	null = execVM "DNT_supplies\DNT_inidbIO.sqf";
	
	//Initialize supply system missions
	null = execVM "DNT_supplies\DNT_initMissions.sqf";
	...
	//Curator handle variable for auto apply
	...
	dnt_ammoContainers = ["JLTS_Ammobox_ammo_GAR",
	...
	publicVariable "dnt_ammoContainers";
	publicVariable "dnt_medicalContainers";
	...
	//Launch supply system
	null = execVM "DNT_supplies\DNT_trackSupplies.sqf";
	
//Case where supply system is off
} else { 

	dnt_ammoCount = 9999;
	dnt_medicalCount = 9999;
	dnt_scrapCount = 9999;
