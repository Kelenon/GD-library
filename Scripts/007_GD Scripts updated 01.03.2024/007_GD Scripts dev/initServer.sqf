...
dnt_ammoCount = 9999; //Update with current amount of ammo from #quartermasters-logbook! channel on discord

dnt_medicalCount = 9999; //Update with current amount of medical supplies from #quartermasters-logbook! channel on discord

dnt_scrapCount = 9999; //Update with current amount of scrap from #quartermasters-logbook! channel on discord
